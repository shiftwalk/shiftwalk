...
export default function ListLink( {slug, title, projectCode} ) {
  ...
  return (
    <Link href={`${slug}`}>
      <a className="w-full group block text-base md:text-xl xl:text-2xl leading-none md:leading-none xl:leading-none uppercase font-display pt-3 pb-2 border-b border-black md:flex md:flex-wrap md:items-center group" onMouseEnter={handleHover} onMouseLeave={handleHoverOut}>
        ...
        <span className="inline-block md:inline-block">{title}</span>
