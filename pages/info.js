      ...
      <LazyMotion features={domAnimation}>
        ...
        >
          <m.article variants={fade}>
            ...
            {/* <div className="fixed top-0 right-0 bottom-0 w-[30%] h-screen pt-[45px] md:pt-[53px] xl:pt-[57px] col-span-3 col-start-8 px-5 hidden md:flex flex-wrap">
              ...
              <div className="w-full mt-auto py-5">
                <m.div variants={childStaggerContainer} className="relative overflow-hidden mb-2">
                  ...
                  <div className="w-full h-[41vw] max-h-[65vh] relative overflow-hidden bg-black">
            ...
            <div className="w-[100%] md:w-[70%] h-full min-h-screen">
              <div className="w-full flex flex-wrap min-h-screen">
                <div className="w-full lg:w-[70%] px-5 flex flex-col pt-[55px] md:pt-[65px] xl:pt-[75px] lg:pb-[85px]">
                  <div className="w-full mb-32 md:mb-32 lg:mb-0">
                    <m.h1 variants={childStaggerContainer} className="font-display text-[7.8vw] md:text-[4.8vw] xl:text-[3.95vw] leading-[1] md:leading-[1] xl:leading-[1] mb-6 md:mb-8 max-w-[95%] md:max-w-[95%] mt-[0vw] hidden xl:block">
                      <div className="relative overflow-hidden">
                        <m.span variants={reveal} className="block will-change-transform"><span className="block translate-y-[-0.45vw]">Information</span></m.span>
                      </div>
                    </m.h1>
                    ...
                    <m.h1 variants={childStaggerContainer} className="font-display text-[7.8vw] md:text-[4.6vw] xl:text-[4vw] leading-[1] md:leading-[1] xl:leading-[1] mb-6 md:mb-8 max-w-[95%] md:max-w-[95%] mt-[0vw] hidden md:block xl:hidden">
                      <div className="relative overflow-hidden">
                        <m.span variants={reveal} className="block will-change-transform"><span className="block translate-y-[-0.55vw]">Information</span></m.span>
                      </div>
                    </m.h1>
                    ...
                    <m.h1 variants={childStaggerContainer} className="font-display text-[7.7vw] md:text-[4.7vw] xl:text-[4vw] leading-[1] md:leading-[1] xl:leading-[1] mb-6 md:mb-8 max-w-[95%] md:max-w-[95%] mt-[0] block md:hidden">
                      <div className="relative overflow-hidden">
                        <m.span variants={reveal} className="block will-change-transform"><span className="block translate-y-[-0.8vw]">Information</span></m.span>
                      </div>
                    </m.h1>
                  </div>
                  ...
                  <div className="mt-auto w-full">
                    ...
                    <span className="flex items-center mb-6 text-sm">
                      <span className="block leading-none font-bold">Background</span>
                    </span>

                    <div className="content w-[85%] md:w-[85%] max-w-[1000px] text-base md:text-lg 2xl:text-[20px] leading-[1.2] md:leading-[1.2] 2xl:leading-[1.2] ">
                ...
                <div className="w-full lg:w-[30%] lg:border-l lg:border-black p-5 pt-8 lg:pt-32 xl:pt-40 pb-8 md:pb-[92px] flex items-end">
                  <div className="w-full">
                    <span className="flex items-center mb-6 text-sm">
                      <span className="block leading-none font-bold">People</span>
                    </span>

                    <div className="text-base md:text-sm leading-[1.25] w-[85%] mb-8 lg:mb-12">
                      <p>{home.peopleText}</p>
                    </div>

                    <span className="flex items-center mb-6 text-sm">
                      <span className="block leading-none font-bold">Expertise</span>
                    </span>
                    ...
                    <span className="flex items-center mb-6 text-sm">
                      <span className="block leading-none font-bold">Select Partners</span>
                    </span>

                    <div className="text-base md:text-sm leading-[1.25] w-[85%]">
                      <ul>
            ...
            <div className="w-full mt-auto md:fixed bottom-0 left-0 right-0 md:w-[70%] bg-white z-10">
              <Footer noRightPad />
            </div>
          </m.article>
        </m.main>
