                  ...
                  <div className="w-full h-[38vw] max-h-[70vh] relative overflow-hidden">
                    ...
                    <MouseParallax enableOnTouchDevice={false} lerpEase={0.1} strength={0.004}>
                      <Image
                        ...
                        layout="fill"
                        className="w-full h-full object-cover object-center absolute inset-0 scale-[1.1]"
              ...
              <div className="flex flex-wrap">
                <div className="w-full lg:w-[70%] p-5 flex flex-wrap">
                  ...
                  <div className="mt-auto w-full">
                    ...
                    <div className="content w-[85%] md:w-[85%] max-w-[1000px] text-sm md:text-xl 2xl:text-[23px] leading-[1.2] md:leading-[1.2] 2xl:leading-[1.2]">
